            ...
            <form action="{{ route('wa.send.otp') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex border border-gray-400 rounded overflow-hidden focus-within:border-[#0a1628] transition-all">
                        ...
                        <div class="bg-gray-50 border-r border-gray-400 px-2 flex items-center">
                            <select name="country_code" class="bg-transparent text-sm text-gray-700 outline-none cursor-pointer py-2 pr-1">
