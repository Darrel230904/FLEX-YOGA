    ...
    <div class="flex flex-col md:flex-row w-full max-w-[850px] rounded-[15px] overflow-hidden shadow-2xl bg-[#0A1628]">
        ...
        <div class="w-full md:w-[55%] bg-white px-12 py-16 flex flex-col justify-center items-center">
            ...
            <p class="text-center text-gray-400 text-[13px] mb-8 leading-relaxed px-4">
                Enter your admin email for the verification proccess, we will send 4 digits code to your email.
            </p>

            <form action="{{ route('admin.forgot.password.process') }}" method="POST" class="w-full">
                @csrf
                <div class="mb-6">
